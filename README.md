...
This repository automatically builds on every push. Download the latest firmware from the [Actions tab](https://github.com/CavemansToys/OpenTrickler-v2/actions) under "Artifacts".
